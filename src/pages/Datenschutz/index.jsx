...
const Datenschutz = () => {
  return (
    <App title='Datenschutz' description='Datenschutzerklaerung der Website.'>
      <Card.Root height='100%' overflow='auto'>
        ...
        <Card.Body>
          ...
          <ul>
            ...
            <li>
              Beim Besuchen der Seite blog.openpv.de nutzen wir ein hosting des
              Anbieters github: Sogenannte github pages. Oben genannte
              ...
              Serverlogs. Entsprechend verweisen wir auf das Privacy Statement
              von Github:
